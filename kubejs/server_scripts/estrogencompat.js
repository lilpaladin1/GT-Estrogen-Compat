...
if (Platform.isLoaded("estrogen")) {
    ...
    ServerEvents.recipes(event => {
        ...
        event.remove([
            ...
            { output: "estrogen:used_filter" },
            { output: "estrogen:centrifuge" },
            { output: "estrogen:testosterone_chunk" },
            { output: "estrogen:testosterone_powder" },
            { output: "estrogen:testosterone_mixture_bucket" },
            { output: "estrogen:filtrated_horse_urine_bucket" },
            { output: "estrogen:horse_urine_bucket" },
            { output: "estrogen:molten_amethyst_bucket" },
            { output: "estrogen:molten_slime_bucket" },
            { output: "estrogen:balls" },
            { output: "estrogen:horse_urine" },
            { output: "estrogen:filtrated_horse_urine" },
            { output: "estrogen:molten_slime" },
            { output: "estrogen:molten_amethyst" },
            { output: "estrogen:testosterone_mixture" }
        ])
        ...
        if (Platform.isLoaded("extendedcrafting")) {
            ...
            event.recipes.gtceu.assembler("estrogen:uwu")
                .itemInputs( "7x estrogen:estrogen_pill_block", "4x gtceu:uranium_triplatinum_hex_wire", "2x gtceu:ev_robot_arm", "gtceu:silicone_rubber_plate", "#gtceu:circuits/iv" )
                .itemOutputs("estrogen:uwu")
                .duration(400)
                .EUt(120)
        }
        ...
        event.recipes.gtceu.centrifuge("moth_fuzz")
